...
factories.lifecycle = function(deps)
    ...
    local allowed = {
        ...
        READY = { DEGRADED = true, UNHEALTHY = true, QUIESCING = true, STOPPING = true },
        DEGRADED = { READY = true, UNHEALTHY = true, QUIESCING = true, STOPPING = true },
        UNHEALTHY = { READY = true, DEGRADED = true, QUIESCING = true, STOPPING = true },
        QUIESCING = { STOPPING = true },
