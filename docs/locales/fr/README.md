...
`synex_notify` est une engine distincte d'orchestration de feedback et de notifications en Experimental Alpha. Elle gère un cycle de vie borné, la file, les priorités, la déduplication, le regroupement, la progression, des actions éphémères, les fences owner/session et les limites de débit ; son rendu passif utilise `synex_ui` sans voler le focus. Les validations réelles FXServer/CEF, redémarrage, accessibilité, manette et performances restent ouvertes.
